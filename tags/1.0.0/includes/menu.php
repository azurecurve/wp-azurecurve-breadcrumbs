...
if (!function_exists('azc_plugin_menus')){
	function azc_plugin_menus() {
		...
		if ( is_plugin_active( 'azurecurve-breadcrumbs/azurecurve-breadcrumbs.php' ) ) {
			echo "<a href='admin.php?page=azc-b' class='azc_plugin_index'>Breadcrumbs</a>";
		}
		...
		echo "<span class='azc_plugin_index'>";
		if ( !is_plugin_active( 'azurecurve-breadcrumbs/azurecurve-breadcrumbs.php' ) ) {
			echo "<a href='https://wordpress.org/plugins/azurecurve-breadcrumbs/' class='azc_plugin_index'>Breadcrumbs</a>";
		}
		if ( !is_plugin_active( 'azurecurve-bbcode/azurecurve-bbcode.php' ) ) {
